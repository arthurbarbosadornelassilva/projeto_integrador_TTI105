...
class TelaLogin:
    ...
    while running:
        ...
        draw_text("LOGIN", font1, (255,255,255), screen, WIDTH // 1.91,330)


        # Desenhar o botão com bordas arredondadas
        if draw_rounded_button(screen, login_aluno_button):
            print("Botão aluno!")
        if draw_rounded_button(screen, login_prof_button):
            print("Botão prof!")
