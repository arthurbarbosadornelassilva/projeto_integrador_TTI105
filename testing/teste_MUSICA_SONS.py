...
lado_x = 40
lado_y = 40
fonte = pygame.font.SysFont("Helvetica", 30, False, False)
...
#DEFININDO MÚSICA
musica_de_fundo = pygame.mixer.music.load("505Loop.mp3")
...
while rodando:
    ...
    if p1.colliderect(p2):
     ...
     #GERANDO TEXTO
    mensagem = f'Joguinho Bom & Com Música'
    texto_formatado = fonte.render(mensagem, True, (255, 255, 255, 100))
    tela.blit(texto_formatado, (300, 50))
