...
class GameOver:
    ...
    #fontees
    font1 = pygame.font.Font('font/PixelifySans-Bold.ttf', 35)
    ...
    while running:
        ...
        draw_text("Você falhou, seu corpo foi dominado!", font1, (255,255,255), screen, WIDTH // 1.91,78)


        # Desenhar o botão com bordas arredondadas
        if draw_rounded_button(screen, botao_jogar_nova):
            print("Botão Jogar Novamento!")
        if draw_rounded_button(screen, menu_button):
            print("Botão Menu!")
