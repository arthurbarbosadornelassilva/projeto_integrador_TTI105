...
#definindo objeto jogador --> Fazer de forma diferente quando as telas de cadastro/login  
jogador = Usuario.Usuario()
jogador.setNomeAluno("José Aldo")
jogador.setEmailAluno("JoseAldo@teste.com")

nome = jogador.getNomeAluno()
email = jogador.getEmailAluno()
